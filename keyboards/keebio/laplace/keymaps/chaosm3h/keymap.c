...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    ...
    KC_LGUI,  KC_LALT,  FN1,      _______,  SP_FN1,   ET_FN2,                       FN2,      _______,  KC_EQL,   _______
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    RGB_MOD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  KC_VOLD,  KC_LCBR,  KC_RCBR,  _______,  KC_LBRC,  KC_RBRC,  _______,  _______,
  ...
  [_FN2] = LAYOUT(
    ...
    _______,  _______,  _______,  KC_INS,   KC_PGUP,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_COLN,  KC_AT,
    _______,  _______,  _______,  KC_DEL,   KC_PGDN,  KC_END,   KC_CIRC,  KC_DLR,   KC_UNDS,  KC_SLSH,  _______,  _______,
